...
NOME DO CURSO - XXXXX (código de 5 dígitos)
...
Formato obrigatório da resposta: Nome do Curso - 00000
...
Resposta final (apenas o curso mais compatível, no formato correto):
        """.strip()
    ...
    with open(ARQUIVO_LOG_ERROS, 'a', encoding='utf-8') as f:
        f.write(f"[FALHA TOTAL] {cbo_nome}: nenhum grupo retornou resposta válida\n")
    return ""
